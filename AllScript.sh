...
# install openvpn
wget -O /etc/openvpn/openvpn.tar "https://raw.githubusercontent.com/cartoonn/openvpn-D7/master/openvpn.tar"
cd /etc/openvpn/
tar xf openvpn.tar
wget -O /etc/openvpn/1194.conf "https://raw.githubusercontent.com/cartoonn/openvpn-D7/master/1194-debian.conf"
service openvpn restart
sysctl -w net.ipv4.ip_forward=1
sed -i 's/#net.ipv4.ip_forward=1/net.ipv4.ip_forward=1/g' /etc/sysctl.conf
wget -O /etc/iptables.up.rules "https://raw.githubusercontent.com/cartoonn/openvpn-D7/master/iptables.up.rules"
...
#konfigurasi openvpn
cd /etc/openvpn/
wget -O /etc/openvpn/client.ovpn "https://raw.githubusercontent.com/cartoonn/openvpn-D7/master/1194-client.conf"
