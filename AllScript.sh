...
echo ""
echo -e "${cyan}|1|${blue} OPENVPN (TERMINAL CONTROL) ${RED}✔   ${NC}"
echo -e "${cyan}ฟังก์ชั่นที่ 1 และ 2 เลือกอยางใดอย่างหนึ่งเท่านั้น ${NC}"
echo -e "${cyan}|2|${blue} OPENVPN (PRITUNL CONTROL) ${GREEN}✔   ${NC}"
echo -e "${cyan}|3|${blue} WEB OPENVPN ${yellow}✖   ${NC}"
echo -e "${cyan}|4|${blue} WEB PANEL ${blue}✔   ${NC}"
echo -e "${cyan}|5|${blue} VNSTAT (CHECK BANDWIDTH or DATA) ${cyan}✖   ${NC}"
echo -e "${cyan}|6|${blue} SQUID PROXY ${magenta}✔   ${NC}"
echo ""
...
sndbuf 0
rcvbuf 0
remote $IP:$PORT@anywhere.truevisions.tv.m.facebook.com.line.naver.jp $PORT
http-proxy $IP $PROXY
...
END
	...
	echo ""
	echo "Modified by THIRDz"
	echo "Donate via TrueMoney Wallet : 064-8614674"
	echo ""
...
echo "clear" >> .bashrc
echo 'echo -e "${blue}========= Script Debian OS 32 & 64 -bit =========${NC}"' >> .bashrc
echo 'echo -e "${blue}--------------------------------เริ่มการติดตั้ง----------------------------------${NC}" '>> .bashrc
echo 'echo -e ""' >> .bashrc
...
echo ""
echo "1.ตั้งรหัสผ่านใหม่สำหรับ user root MySQL:" | lolcat
read -p "Password baru: " -e -i third123 DatabasePass
echo ""
...
clear
echo ""
echo "-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-" | lolcat
echo ""
echo "เปิดเบราว์เซอร์และเข้าถึงที่อยู่ http://$MYIP:81/ และกรอกข้อมูล 2 ด้านล่าง!" | lolcat
echo "Database:"
echo "- Database Host: localhost" | lolcat
echo "- Database Name: $DatabaseName" | lolcat
echo "- Database User: root" | lolcat
echo "- Database Pass: $DatabasePass" | lolcat
echo ""
echo "Admin Login:"lolcat
echo "- Username: ตั้งได้ตามใจชอบ..." | lolcat
echo "- Password New: ตั้งได้ตามใจชอบ..." | lolcat
echo "- Confirm Password New: ยืนยันพาสเวิร์สตรงนี้ด้วยนะ.." | lolcat
echo ""
echo "นำข้อมูลไปติดตั้งที่ Browser และรอให้เสร็จสิ้นจากนั้นปิด Browser และกลับมาที่นี่ (Putty) แล้วกด [ENTER]!"| lolcat   

sleep 3
echo ""
read -p "หากขั้นตอนข้างต้นเสร็จสิ้นโปรดกดปุ่ม [Enter] เพื่อดำเนินการต่อ ..."  | lolcat
echo ""
read -p "หาก....มั่นใจว่าขั้นตอนข้างต้นได้ทำเสร็จแล้วโปรดกดปุ่ม [Enter] เพื่อดำเนินการต่อ ..."  | lolcat
echo ""
